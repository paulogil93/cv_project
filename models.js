...
function recSubdivisionCentroid( v1, v2, v3, 
	...
	{
		// Compute centroid and proceed recursively
		...
		recSubdivisionCentroid(v1, v2, vc, c1, c2, cc, coordsArray, colorsArray, recursionDepth - 1);

		recSubdivisionCentroid(v2, v3, vc, c2, c3, cc, coordsArray, colorsArray, recursionDepth - 1);

		recSubdivisionCentroid(v3, v1, vc, c3, c1, cc, coordsArray, colorsArray, recursionDepth - 1);
	}
}
...
function centroidRefinement( coordsArray, 
	...
	for(origIndex = 0; origIndex < origArrayLength; origIndex += 9)
	{
		recSubdivisionCentroid(origCoords.slice(origIndex, origIndex + 3), origCoords.slice(origIndex + 3, origIndex + 6), origCoords.slice(origIndex + 6, origIndex + 9), origColors.slice(origIndex, origIndex + 3), origColors.slice(origIndex + 3, origIndex + 6), origColors.slice(origIndex + 6, origIndex + 9), coordsArray, colorsArray, recursionDepth);
	}
}
